...
<template>
    ...
    <div class="relative">
        ...
        <input 
            ...
            class="bg-white/5 border border-white/10 rounded-xl pl-9 pr-4 py-2 text-sm focus:ring-2 focus:ring-violet-500 outline-none w-64"
        />
    </div>

    <Link 
        :href="route('admin.users.create')" 
        class="bg-violet-600 hover:bg-violet-700 px-4 py-2 rounded-xl text-sm font-semibold transition-all shadow-lg shadow-violet-900/20"
    >
        + Add User
    </Link>
</div>
